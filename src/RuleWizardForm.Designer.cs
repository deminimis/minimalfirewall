namespace MinimalFirewall
{
    partial class RuleWizardForm
    {
        ...
        {
            pnlSelection = new DarkModeForms.ThemedPanel();
            restrictAppButton = new DarkModeForms.ThemedButton();
            blockDeviceButton = new DarkModeForms.ThemedButton();
            allowFileShareButton = new DarkModeForms.ThemedButton();
            blockServiceButton = new DarkModeForms.ThemedButton();
            advancedRuleButton = new DarkModeForms.ThemedButton();
            wildcardRuleButton = new DarkModeForms.ThemedButton();
            portRuleButton = new DarkModeForms.ThemedButton();
            batchProgramRuleButton = new DarkModeForms.ThemedButton();
            programRuleButton = new DarkModeForms.ThemedButton();
            pnlGetProgram = new DarkModeForms.ThemedPanel();
            browseButton = new DarkModeForms.ThemedButton();
            programPathTextBox = new TextBox();
            pnlGetFolder = new DarkModeForms.ThemedPanel();
            dllCheckBox = new CheckBox();
            exeCheckBox = new CheckBox();
            batchBrowseFolderButton = new DarkModeForms.ThemedButton();
            batchFolderPathTextBox = new TextBox();
            pnlGetPorts = new DarkModeForms.ThemedPanel();
            portsProgramPathTextBox = new TextBox();
            portsBrowseButton = new DarkModeForms.ThemedButton();
            restrictToProgramCheckBox = new CheckBox();
            portsTextBox = new TextBox();
            portsLabel = new DarkModeForms.ThemedLabel();
            pnlGetProtocol = new DarkModeForms.ThemedPanel();
            bothProtocolRadioButton = new RadioButton();
            udpRadioButton = new RadioButton();
            tcpRadioButton = new RadioButton();
            pnlSummary = new DarkModeForms.ThemedPanel();
            summaryLabel = new DarkModeForms.ThemedLabel();
            pnlGetName = new DarkModeForms.ThemedPanel();
            ruleNameTextBox = new TextBox();
            bottomPanel = new DarkModeForms.ThemedPanel();
            cancelButton = new DarkModeForms.ThemedButton();
            nextButton = new DarkModeForms.ThemedButton();
            backButton = new DarkModeForms.ThemedButton();
            topPanel = new DarkModeForms.ThemedPanel();
            mainHeaderLabel = new DarkModeForms.ThemedLabel();
            pnlGetAction = new DarkModeForms.ThemedPanel();
            blockActionRadioButton = new RadioButton();
            allowActionRadioButton = new RadioButton();
            pnlGetDirection = new DarkModeForms.ThemedPanel();
            bothDirRadioButton = new RadioButton();
            inboundRadioButton = new RadioButton();
            outboundRadioButton = new RadioButton();
            pnlGetService = new DarkModeForms.ThemedPanel();
            serviceNameTextBox = new TextBox();
            serviceListBox = new ListBox();
            serviceInstructionLabel = new DarkModeForms.ThemedLabel();
            pnlGetFileShareIP = new DarkModeForms.ThemedPanel();
            fileShareIpTextBox = new TextBox();
            fileShareWarningLabel = new DarkModeForms.ThemedLabel();
            pnlGetBlockDeviceIP = new DarkModeForms.ThemedPanel();
            blockDeviceIpTextBox = new TextBox();
            pnlGetRestrictApp = new DarkModeForms.ThemedPanel();
            restrictAppPathTextBox = new TextBox();
            restrictAppBrowseButton = new DarkModeForms.ThemedButton();
        ...
        private DarkModeForms.ThemedPanel pnlSelection;
        private DarkModeForms.ThemedButton advancedRuleButton;
        private DarkModeForms.ThemedButton wildcardRuleButton;
        private DarkModeForms.ThemedButton portRuleButton;
        private DarkModeForms.ThemedButton programRuleButton;
        private DarkModeForms.ThemedButton batchProgramRuleButton;
        private DarkModeForms.ThemedPanel pnlGetProgram;
        private DarkModeForms.ThemedPanel pnlGetFolder;
        private DarkModeForms.ThemedPanel pnlGetPorts;
        private DarkModeForms.ThemedPanel pnlGetProtocol;
        private DarkModeForms.ThemedPanel pnlSummary;
        private DarkModeForms.ThemedPanel pnlGetName;
        private DarkModeForms.ThemedPanel bottomPanel;
        private DarkModeForms.ThemedButton cancelButton;
        private DarkModeForms.ThemedButton nextButton;
        private DarkModeForms.ThemedButton backButton;
        private DarkModeForms.ThemedPanel topPanel;
        private DarkModeForms.ThemedLabel mainHeaderLabel;
        private DarkModeForms.ThemedButton browseButton;
        private System.Windows.Forms.TextBox programPathTextBox;
        private DarkModeForms.ThemedButton batchBrowseFolderButton;
        private System.Windows.Forms.TextBox batchFolderPathTextBox;
        private System.Windows.Forms.TextBox portsTextBox;
        private DarkModeForms.ThemedLabel portsLabel;
        ...
        private DarkModeForms.ThemedLabel summaryLabel;
        private DarkModeForms.ThemedPanel pnlGetAction;
        ...
        private DarkModeForms.ThemedPanel pnlGetDirection;
        ...
        private DarkModeForms.ThemedButton portsBrowseButton;
        private System.Windows.Forms.TextBox portsProgramPathTextBox;
        private DarkModeForms.ThemedButton blockServiceButton;
        private DarkModeForms.ThemedButton allowFileShareButton;
        private DarkModeForms.ThemedButton blockDeviceButton;
        private DarkModeForms.ThemedButton restrictAppButton;
        private DarkModeForms.ThemedPanel pnlGetService;
        private DarkModeForms.ThemedPanel pnlGetFileShareIP;
        private DarkModeForms.ThemedPanel pnlGetBlockDeviceIP;
        private DarkModeForms.ThemedPanel pnlGetRestrictApp;
        private TextBox serviceNameTextBox;
        private ListBox serviceListBox;
        private DarkModeForms.ThemedLabel serviceInstructionLabel;
        private TextBox fileShareIpTextBox;
        private DarkModeForms.ThemedLabel fileShareWarningLabel;
        private TextBox blockDeviceIpTextBox;
        private TextBox restrictAppPathTextBox;
        private DarkModeForms.ThemedButton restrictAppBrowseButton;
